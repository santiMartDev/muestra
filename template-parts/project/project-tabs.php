...
<ul class="tabs">
    ...
    <?php // Tab Link Artist  ?>
    <?php if ( !empty($project['artist']['media']['video_gallery']) || !empty($project['artist']['media']['gallery']) || !empty($project['artist']['media']['video_single']['number']) || !empty($project['artist']['extra']['iframe']) ) :  ?>
