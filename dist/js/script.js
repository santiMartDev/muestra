(function () {
    ...
    function animatedItems() {
      ...
      ScrollTrigger.addEventListener("refreshInit", () => gsap.set(".animated-item", {
        y: 0
      }));
    }
    ...
    const events = (swiper, method) => {
      ...
      if (params.updateOnWindowResize) {
        swiper[swiperMethod](device.ios || device.android ? 'resize orientationchange observerUpdate' : 'resize observerUpdate', onResize$1, true);
      } else {
        swiper[swiperMethod]('observerUpdate', onResize$1, true);
      }
  ...
  .replace(/ /g, '.')}`;
    ...
    function soundWave() {
      ...
      while (n > 0) {
        jQuery(".sound-wave").append(jQuery(".sound-wave").children().first().clone());
        n -= 1;
      }
    }
